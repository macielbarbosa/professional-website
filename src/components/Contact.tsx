      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <a
            ...
            className="flex items-center gap-3 rounded-lg border border-border p-4 transition-colors hover:border-accent hover:bg-accent-soft"
          >
          ...
          >
            ...
            <div>
              <p className="text-xs font-medium text-muted">{t.contact.phone}</p>
              <p className="text-sm font-medium text-ink">{profile.phoneDisplay}</p>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm font-medium text-ink">macielbarbosa</p>
            </div>
          </a>
